        ...
        <div className='min-h-screen flex flex-col'>
            ...
            <main className='max-w-5xl mx-auto w-full px-5 py-10 flex-grow'>
                ...
                <div className='sm:hidden grid grid-cols-1 gap-6'>
                    {tarefas.map((tarefa) => 
                        <div key={tarefa.id} className={`gap-3 flex flex-col rounded-lg shadow  ring-1  ring-black py-4 px-5 ring-opacity-50 ${tarefa.status ? 'bg-green-100' : 'bg-gray-100'}`}>
                            ...
                            <div className='flex justify-between items-center'>
                                <span className=''>{tarefa.status ? "Concluida" : "Pendente"}</span> 
                            ...
                            <div className='flex justify-between gap-7 items-center'>                                       
                                {tarefa.descricao ? <p className='break-words min-w-0 '>{tarefa.descricao}</p> : <p className='text-gray-600 italic'>Sem Descrição</p>}
